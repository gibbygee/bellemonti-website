...
It makes me think of the industry that exists around "fixing" software companies. There is a orbit of people around this - the "transformation" consulting crowd; endless authors and academics who document the innovators dilemma, zones to win, 5 dysfunctions; yadda yadda yadda. Copious writing on re-inventing companies in general, and software companies in particular.
...
In the most assertive of cases you start building a masterpiece of corporate operational planning - V2MOM, OKRs, and so forth. Lots of examples here and honestly they all have some merit. But also they all are equally overwrought and the sheer weight of them will starting dragging you under the waves. 

Many times this "renovation" problem arises in the late stages of a public company, but not always. Software companies can flatten out at pretty much any age. Typically the core problem is - the products are mature. So, then, how the heck do you take a mature product and reinvigorate it?? 

Arguably, you can't. You can't turn a 1998 Toyota Camry into a 2024 Tesla. Years ago in b-school I had the presence of mind to ask my marketing professor what he thought about Crossing the Chasm, which was popular at the time. His response I thought was thoughtful - ultimately it's about the product lifecycle.
...
Or, you could buy. Which is a common strategy, and also expensive.

But if the answer is "no" for both of these, then you basically need to make do with what you have. Sweat the asset. As long as you can. 
...
A way to reliably set priorities

A way to put those priorities into development.

Have some amount of predictability on when your priorities will emerge.

Have confidence that when the execution of these priorities emerges (in the form of finished software), that they will be reliably marketable and useful

And lastly - when you do discover a problem / opportunity with something that was built, you can push it back to step 1, and start the cycle anew
...
Maybe building these control surfaces is ... as good as it gets. Because, this is how you maximize your products as they get older. And extending that timeline is very very lucrative.
