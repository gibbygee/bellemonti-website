...
redirect_from:
  ...
  - /dispatches/maybe-pm-should-be-slow/
---
...
But here's the thing about software - it's CUMULATIVE. Every single thing you build sits there forever, like digital sediment, forming the foundation for everything that comes after.

So maybe the real job of Product Management is to be the speed bump. The pause button. The "wait, but why?" person.

Because going fast isn't necessarily the hard part. Any decently caffeinated dev team can crank out features. 
